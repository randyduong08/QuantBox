...
const GreeksCharts = ({ initialParams }: Props): JSX.Element => {
  ...
  const calculateGreeksData = () => {
    ...
    const priceRange: number = strikePrice * 0.5; // 50% range
    const minPrice: number = strikePrice - priceRange;
    const maxPrice: number = strikePrice + priceRange;
    const steps = 100;
    const stepSize: number = (maxPrice - minPrice) / steps;

    const newData = [];

    for (let i = 0; i <= steps; i++) {
      const spotPrice: number = minPrice + i * stepSize;
      const greeks: GreeksFields = calculateGreeks(
        spotPrice,
        strikePrice,
        riskFreeRate,
        volatility,
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <p className="text-gray-400 mb-4">
              Rate of change of option price with respect to the underlying
              asset price.
            </p>
            <div className="h-64">
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <p className="text-gray-400 mb-4">
              Rate of change of Delta with respect to the underlying asset
              price.
            </p>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="bg-gray-800 p-4 rounded-lg">
            ...
            <p className="text-gray-400 mb-4">
              Sensitivity to volatility changes (per 1% change in volatility).
            </p>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={greeksData}>
